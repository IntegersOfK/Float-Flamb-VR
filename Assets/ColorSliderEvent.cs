...
{
    public class ColorSliderEvent : NVRInteractable
    {
        ...
        public delegate void ChangeEvent(float value); //I do declare!
        ...
        public override void EndInteraction()
        {
            ...
            if (changeEvent != null)
            {  // checking if anyone is on the other line.
                changeEvent(this.CurrentValue);
            }
            base.EndInteraction();
